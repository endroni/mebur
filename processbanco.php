...
####################################################################################################################################################
# SCRIPT CRIADO PARA AUXILIAR OS ALUNOS DO INFORMÁTIA, DISCIPLINA DE BANCO DE DADOS DA ESCOLA ESTADUAL PROFESSOR FONTES -                               PROF. RUBEM                                                         #
####################################################################################################################################################
...
<?php
error_reporting(E_ALL & ~E_NOTICE & ~E_WARNING); // Sintaxe para não mostrar os alerta
	...
	$answer30 = $_POST['answerTwentyThirty'];
...
<form action='banco.php' method='post' id='quizForm' id='4'>
